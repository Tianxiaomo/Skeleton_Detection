...
{      
    ...
    { 
        RTC_Set_Time(15,8,56,RTC_HOURFORMAT12_PM);	        //设置时间 ,根据实际时间修改
		RTC_Set_Date(18,9,16,7);		                    //设置日期
...
dateAndTime_t *RTC_getDateAndTime(void)
{
	...
	dateAndTime.year    = RTC_DateStruct.Year;
	dateAndTime.month   = RTC_DateStruct.Month;
	dateAndTime.date    = RTC_DateStruct.Date;
	dateAndTime.week    = RTC_DateStruct.WeekDay;
	dateAndTime.hour    = RTC_TimeStruct.Hours;
	dateAndTime.minute  = RTC_TimeStruct.Minutes;
	dateAndTime.second  = RTC_TimeStruct.Seconds;
	dateAndTime.ampm    = RTC_TimeStruct.TimeFormat; 
